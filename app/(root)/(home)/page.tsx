    ...
    <>
        ...
        <div className="gap-8 grid grid-cols-3">
          <div className="space-y-6 col-span-3 lg:col-span-2 pt-10">
            <h1 className="font-voska text-5xl lg:text-[84px] leading-none">
              Join the <span className="font-voska-outline">local</span>
              <br />
              recycling movement.
            </h1>
      ...
      <Container className="text-center">
        <div className="space-y-10 lg:space-y-20">
          <div className="space-y-6">
            <p className="font-voska text-4xl lg:text-7xl">How BIN app works</p>
            <p className="mx-auto max-w-lg text-muted-foreground text-pretty text-sm lg:text-base">
              Ready to turn trash into treasure? Discover how easy it is to
              recycle and get rewarded with BIN app. Follow these simple steps
              to start making a positive impact on the planet today.
            </p>
          </div>
          ...
          <div className="place-content-center gap-10 lg:gap-4 grid grid-cols-3">
            <div className="space-y-4 col-span-3 lg:col-span-1">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-80 lg:max-w-60 text-muted-foreground text-sm">
                  Use BIN app to scan items with barcodes or snatch a photo
                  using BIN image recognition technology to identify any
                  material.
                </p>
              </div>
            </div>
            <div className="space-y-4 col-span-3 lg:col-span-1">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-80 lg:max-w-60 text-muted-foreground text-sm">
                  Locate the nearest waste or recycling location through our
                  app, or register your own. Dispose any of your items properly.
                </p>
              </div>
            </div>
            <div className="space-y-4 col-span-3 lg:col-span-1">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-80 lg:max-w-60 text-muted-foreground text-sm">
                  Complete challenges, track your environmental impact and get
                  rewarded.
                </p>
              </div>
            </div>
      ...
      <Container className="bg-[url('/red-cans.png')] bg-cover bg-no-repeat bg-center lg:py-36">
        <div className="relative -z-10 space-y-2 bg-[#ffe9f2] p-10 lg:p-24 rounded-3xl">
          <p className="text-xs lg:text-sm">SMALL ACTIONS. BIG DIFFERENCE.</p>
          <p className="font-voska text-[#fb2850] text-5xl lg:text-7xl">
            Together we will sort{" "}
            <span className="font-voska-outline"> millions</span> of packages.
          </p>
        </div>
      </Container>
          ...
          <div className="space-y-6 col-span-3 lg:col-span-2">
            <div className="space-y-2">
              ...
              <p className="font-voska text-3xl lg:text-5xl">
                Sort your waste, get rewarded, and track your CO₂ savings
              </p>
            </div>

            <p className="text-muted-foreground text-sm lg:text-base">
              Join the global movement turning recycling into a game with BIN —
              all while making a real impact on our planet. Download BIN for
              free and start your recycling journey today!
            </p>
            ...
            <div className="gap-6 grid grid-cols-2">
              <div className="space-y-2">
                ...
                <p className="max-w-72 text-muted-foreground text-pretty text-xs lg:text-sm">
                  Easily identify materials, products, and brands—with or
                  without barcodes. It&apos;s like having a recycling buddy in
                  your pocket thats guiding and educating you on how to sort
                  your waste.
                </p>
              </div>
              <div className="space-y-2">
                <p className="font-bold text-sm lg:text-base">Fun Challenges</p>
                <p className="max-w-72 text-muted-foreground text-pretty text-xs lg:text-sm">
                  Dive into exciting challenges and competitions to earn
                  experience points (XP) to unlock levels and collect trophies.
                </p>
              </div>
              <div className="space-y-2">
                <p className="font-bold text-sm lg:text-base">
                ...
                <p className="max-w-72 text-muted-foreground text-pretty text-xs lg:text-sm">
                  See how much CO₂ you&apos;re saving and watch your positive
                  impact grow. Every bit helps!
                </p>
              </div>
              <div className="space-y-2">
                <p className="font-bold text-sm lg:text-base">
                ...
                <p className="max-w-72 text-muted-foreground text-pretty text-xs lg:text-sm">
                  Use the app to recycle wherever you are and join a global
                  community working towards a cleaner planet.
                </p>
              </div>
            </div>
          </div>
      ...
      <Container className="bg-[url('/temp/34.png')] bg-contain bg-no-repeat bg-center my-20 text-center">
        <Link href={"why-we-exist"}>
          <Button variant={"secondary"} className="text-primary" size={"lg"}>
