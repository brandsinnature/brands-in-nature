        ...
        <>
            <Container className="bg-[#f8f2ea]">
                <div className="gap-8 grid grid-cols-3">
                    <div className="space-y-6 col-span-2 pt-10">
                        <h1 className="font-voska text-[84px] leading-none">
                            Join the{" "}
                    ...
                    <div className="relative col-span-1 min-h-96">
                        <Image
                            src="/hero_img-1.webp"
                            alt="hero image"
                            fill
            ...
            <Container className="text-center">
                <div className="space-y-20">
                    ...
                    <div className="place-content-center grid grid-cols-3">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-60 text-muted-foreground text-sm">
            ...
            <Container className="bg-[#cce4ff]">
                <p className="mb-6 text-blue-600 text-center">LATEST NEWS</p>
                <HomeCarousel />
            </Container>

            <Container className="bg-[url('/red-cans.png')] bg-cover bg-no-repeat bg-center py-36">
                <div className="relative -z-10 space-y-2 bg-[#ffe9f2] p-24 rounded-3xl">
                    <p className="text-sm">SMALL ACTIONS. BIG DIFFERENCE.</p>
                    <p className="font-voska text-[#fb2850] text-7xl">
                        Together we&apos;ve will sort over{" "}
            ...
            <section className="py-24 text-center">
                <div className="space-y-4">
                    <p className="mx-auto max-w-4xl font-voska text-7xl">
            ...
            <Container className="bg-[#daf2e5]">
                <div className="gap-10 grid grid-cols-3">
                    <div className="relative my-auto min-h-[500px]">
                        <Image
                            src="/barcodeless.png"
                            alt="barcodeless"
                            fill
                    ...
                    <div className="space-y-6 col-span-2">
                        ...
                        <div className="gap-6 grid grid-cols-2">
                            <div className="space-y-2">
                                <p className="font-bold">Smart Recognition</p>
                                <p className="max-w-72 text-muted-foreground text-pretty text-sm">
                            ...
                            <div className="space-y-2">
                                <p className="font-bold">Fun Challenges</p>
                                <p className="max-w-72 text-muted-foreground text-pretty text-sm">
                            ...
                            <div className="space-y-2">
                                <p className="font-bold">Track Your Impact</p>
                                <p className="max-w-72 text-muted-foreground text-pretty text-sm">
                            ...
                            <div className="space-y-2">
                                <p className="font-bold">Recycle Anywhere</p>
                                <p className="max-w-72 text-muted-foreground text-pretty text-sm">
